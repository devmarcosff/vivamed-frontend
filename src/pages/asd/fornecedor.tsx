                ...
                <div className="p-4 w-full">
                    <div className="mb-6">
                        <div className="grid grid-cols-1 gap-4">
                            <Tab
                                label="1. Fornecedor"
                                active={currentStep === 'fornecedor'}
                                disabled={currentStep !== 'fornecedor'}
                                onClick={() => currentStep === 'fornecedor' && setCurrentStep('fornecedor')}
                            />
                            {/* <Tab
                                label="2. Nota Fiscal"
                                active={currentStep === 'endereco'}
                                disabled={currentStep !== 'endereco'}
                                onClick={() => currentStep === 'endereco' && setCurrentStep('endereco')}
                            /> */}
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSupplierSubmit} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e: any) => setSupplierData({ ...supplierData, name: e.target.value })}
                                            required
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e: any) => setSupplierData({ ...supplierData, cnpj: e.target.value })}
                                            required
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e: any) => setSupplierData({ ...supplierData, email: e.target.value })}
                                            required
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e: any) => setSupplierData({ ...supplierData, phone: e.target.value })}
                                            required
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e: any) => setSupplierData({ ...supplierData, address: e.target.value })}
                                        required
                                    />
                                </div>
